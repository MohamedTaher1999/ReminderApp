...
public class RemindersActivity extends AppCompatActivity implements ActionMode.Callback, ReminderInterface {
    ...
    public void addReminder(final String reminderTitle, final String reminderDTS, final long reminderTIM, final String reminderDTS2, final long reminderTIM2) {
        ...
        Runnable addReminderRunnable = new Runnable() {
            ...
            public void run() {
                ...
                newReminderId[0] = remindersDatabaseAdapter.createReminder(reminderTitle, reminderDTS,reminderDTS2);
        ...
        String reminderDOF = reminderDTS2.substring(7, 17);
        String reminderTOF = reminderDTS2.substring(0, 5);
    ...
    public void updateReminder(final String reminderTitle, final String reminderDTS,final String reminderDTS2, final long reminderTIM, final int reminderId, final int reminderPosition) {
        Runnable updateReminderRunnable = new Runnable() {
            @Override
            public void run() {
                remindersDatabaseAdapter.updateReminder(reminderId,reminderTitle,reminderDTS,reminderDTS2);
            }
        };
        ...
        updateReminderListItem(reminderTitle,reminderDTS2,reminderTIM,reminderPosition);

        setNextReminderAlarm();

        Snackbar.make(rARootLayout, "تم تعديل المناسبة",Snackbar.LENGTH_SHORT).show();
    }
    ...
    private void initializeReminderList() {
        Runnable initializeRListRunnable = new Runnable() {
            @Override
            public void run() {
                reminderList = remindersDatabaseAdapter.fetchReminders2();
            }
        };
